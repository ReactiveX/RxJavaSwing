...
public enum HierarchyEventSource {
    ...
    /**
     * @see SwingObservable#fromHierachyEvents
     */
    ...
    /**
     * @see SwingObservable#fromHierachyBoundsEvents
     */
    ...
    public static enum Predicate implements io.reactivex.functions.Predicate<HierarchyEvent> {
